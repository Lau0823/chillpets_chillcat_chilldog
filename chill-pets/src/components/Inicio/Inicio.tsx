...
{/* HERO VIDEO (MODERNO + STREET + GLASS) */}
<section className="relative mx-4 md:mx-10 mt-6 overflow-hidden rounded-[28px]">
  <div className="relative h-[90vh] min-h-[560px] w-full">
    ...
    <video
      ...
      playsInline
      preload="metadata"
      poster="/hero-poster.jpg" // opcional: pon una imagen poster en /public
    >
      {/* Si tienes webm, mejor para performance */}
      <source src="/hero.webm" type="video/webm" />
      <source src="/hero.mp4" type="video/mp4" />
    </video>

    {/* Overlays para lectura (fondo blanco general, pero banner pro) */}
    ...
    <div className="relative z-10 flex h-full items-center px-6 md:px-14">
      <div className="max-w-2xl rounded-[28px] border border-black/10 bg-white/55 p-6 md:p-10 backdrop-blur-xl shadow-[0_18px_60px_rgba(0,0,0,0.12)]">
        ...
        <p className="mt-4 max-w-lg text-sm md:text-lg text-black/60">
          Jóvenes, street y moderno. Camisetas, hoodies y gorras para romperla
          todos los días.
        </p>
        ...
        <div className="mt-6 grid grid-cols-3 gap-3">
          <div className="rounded-2xl border border-black/10 bg-white/60 p-3 backdrop-blur">
            <p className="text-xs text-black/50">Estilo</p>
    ...
    {/* TICKER / MARQUEE (se siente motion/video) */}
